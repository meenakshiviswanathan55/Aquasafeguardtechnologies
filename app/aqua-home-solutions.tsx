...
export default function AquaHomeSolutions() {
          ...
          <div className="grid grid-cols-1 gap-10 md:gap-12">
            <div className="product-card bg-white rounded-lg shadow-md p-6 md:p-8 flex flex-col md:flex-row items-center md:items-start gap-6 md:gap-8">
              <div className="product-image-container flex-shrink-0 w-full md:w-1/3 text-center">
                ...
                <div className="flex justify-center space-x-2">
                  <button
                    className="color-dot w-6 h-6 rounded-full bg-gray-400 border-2 border-transparent hover:border-blue-500 transition-all duration-200"
                    onClick={() =>
                  ...
                  ></button>
                  <button
                    className="color-dot w-6 h-6 rounded-full bg-gray-800 border-2 border-transparent hover:border-blue-500 transition-all duration-200"
                    onClick={() =>
            ...
            <div className="product-card bg-white rounded-lg shadow-md p-6 md:p-8 flex flex-col md:flex-row items-center md:items-start gap-6 md:gap-8">
              <div className="product-image-container flex-shrink-0 w-full md:w-1/3 text-center">
                ...
                <div className="flex justify-center space-x-2">
                  <button
                    className="color-dot w-6 h-6 rounded-full bg-blue-400 border-2 border-transparent hover:border-blue-500 transition-all duration-200"
                    onClick={() => changeProductImage("canik", "/placeholder.svg?height=250&width=200&text=CANIK+Blue")}
                    aria-label="View blue CANIK"
                  ></button>
                  <button
                    className="color-dot w-6 h-6 rounded-full bg-gray-600 border-2 border-transparent hover:border-blue-500 transition-all duration-200"
