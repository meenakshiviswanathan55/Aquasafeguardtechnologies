                      ...
                      <div className="relative flex justify-center items-center mt-8 lg:mt-0">
                        {slide.image && (
                          <Image
                            ...
                            alt={slide.alt}
                            width={slide.image.includes("height=200") ? 150 : 300} // Adjust width based on placeholder query
                            height={slide.image.includes("height=200") ? 200 : 400} // Adjust height based on placeholder query
