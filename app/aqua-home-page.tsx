...
export default function AquaHomePage() {
    ...
    <main className="pt-28 md:pt-32">
        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-8 md:gap-12 items-center">
            <div className="relative flex justify-center mb-8 lg:mb-0">
              ...
              />
              <div className="absolute -top-4 -left-4 w-20 h-20 bg-blue-400 opacity-20 rounded-full blur-lg"></div>
      ...
      <section className="py-16 md:py-20 bg-gradient-to-b from-sky-200 to-blue-200 relative overflow-hidden">
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="absolute top-6 left-1/3 w-3 h-3 bg-blue-400 rounded-full opacity-40"></div>
