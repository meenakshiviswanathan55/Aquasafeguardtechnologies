...
export default function AquaProductsOverview() {
  return (
    <main className="pt-28 md:pt-32">
            ...
            <div className="container mx-auto px-4 relative z-10">
              <div className="grid lg:grid-cols-2 gap-12 items-center">
                ...
                <div className="text-center lg:text-left space-y-6">
                  ...
                  <Link
                    href="/aqua-industrial-treatment"
                    className="inline-block bg-aqua-button hover:bg-aqua-button-dark text-white px-8 py-4 rounded-full font-semibold text-lg transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105"
                  >
                    Explore now
                  </Link>
                </div>
            ...
            <div className="container mx-auto px-4 relative z-10">
              <div className="grid lg:grid-cols-2 gap-12 items-center lg:grid-flow-col-dense">
                ...
                <div className="text-center lg:text-left space-y-6 lg:col-start-1">
                  ...
                  <Link
                    href="/aqua-water-softening-systems"
                    className="inline-block bg-aqua-button hover:bg-aqua-button-dark text-white px-8 py-4 rounded-full font-semibold text-lg transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105"
                  >
                    Explore now
                  </Link>
      ...
      <section className="py-16 md:py-20 bg-gradient-to-r from-aqua-blue to-blue-500 text-white relative overflow-hidden">
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <Link
            href="/aqua-contact-info"
            className="inline-block bg-white text-aqua-blue px-8 py-4 rounded-full font-semibold text-lg transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105"
          >
