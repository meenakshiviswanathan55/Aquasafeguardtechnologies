...
export default function AquaMainFooter() {
  return (
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400 text-sm">
              <li>
                <Link href="/aqua-domestic-products" className="hover:text-aqua-blue">
                  Domestic Products
                </Link>
              </li>
              <li>
                <Link href="/aqua-commercial-systems" className="hover:text-aqua-blue">
                  Commercial Solutions
                </Link>
              </li>
              <li>
                <Link href="/aqua-industrial-treatment" className="hover:text-aqua-blue">
          ...
          <div>
            ...
            <div>
              ...
              <ul className="space-y-1 text-gray-400 text-sm">
                <li>
                  <Link href="/aqua-homepage" className="hover:text-aqua-blue">
                    Home
                  </Link>
                </li>
                <li>
                  <Link href="/aqua-products-overview" className="hover:text-aqua-blue">
                    Products
                  </Link>
                </li>
                <li>
                  <Link href="/aqua-contact-info" className="hover:text-aqua-blue">
                    Contact Us
                  </Link>
                </li>
                <li>
