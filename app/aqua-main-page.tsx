...
export default function AquaMainPage() {
    ...
    <main className="pt-28 md:pt-32">
      ...
      <section id="home" className="relative overflow-hidden bg-gradient-to-b from-sky-50 to-blue-100">
        ...
        <div className="slider-container relative h-screen">
          {slides.map((slide, index) => (
            <div key={index} className={`slide absolute inset-0 ${index === slideIndex ? "active" : ""}`}>
              <div className="container mx-auto px-4 h-full flex items-center relative z-10 py-32 md:py-40 lg:py-48">
                <div className="grid lg:grid-cols-2 gap-8 md:gap-12 items-center w-full">
                  <div className="flex flex-col space-y-6">
                    ...
                    <p className="text-base md:text-lg text-gray-700 leading-relaxed max-w-lg">{slide.description}</p>
                    <Link
                      href="/products"
                      className="inline-block bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-full font-semibold text-base md:text-lg transition-colors duration-300 shadow-lg w-fit"
                    >
                      Explore now
                    </Link>
                  </div>
      ...
      <section className="py-16 md:py-20 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-8 md:gap-10">
            <div className="bg-gradient-to-br from-blue-500 to-blue-600 text-white p-8 md:p-10 rounded-xl">
            ...
            <div className="bg-gradient-to-br from-blue-600 to-blue-500 text-white p-8 md:p-10 rounded-xl">
      ...
      <section id="products" className="py-16 md:py-20 bg-gradient-to-b from-sky-50 to-blue-50">
        <div className="container mx-auto px-4">
          ...
          <div className="text-center mt-8 md:mt-10">
            <Link
              href="/products"
              className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 md:px-8 md:py-3 rounded-full font-semibold text-base md:text-lg transition-colors duration-300"
            >
              See more
            </Link>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-8 md:gap-12 items-center">
            <div className="relative flex justify-center mb-8 lg:mb-0">
              ...
              <div className="absolute -top-4 -left-4 w-20 h-20 bg-blue-500 opacity-20 rounded-full blur-lg"></div>
      ...
      <section className="py-16 md:py-20 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            ...
            <div className="bg-gradient-to-br from-blue-600 to-blue-500 text-white p-6 rounded-xl">
              <div className="flex items-center mb-4">
                <Image
      ...
      <section className="py-16 md:py-20 bg-gradient-to-b from-sky-200 to-blue-200 relative overflow-hidden">
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="absolute top-16 right-1/3 w-2 h-2 bg-blue-500 rounded-full opacity-70"></div>
          ...
          <div className="absolute top-6 left-1/3 w-3 h-3 bg-blue-500 rounded-full opacity-40"></div>
            ...
            <div className="bg-white rounded-3xl shadow-xl p-10 lg:p-14">
              <div className="grid lg:grid-cols-2 gap-8 md:gap-12 items-center">
                <div className="space-y-6 md:space-y-8">
                  ...
                  <Link
                    href="/contact"
                    className="inline-block bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 md:px-8 md:py-4 rounded-full font-semibold text-base md:text-lg transition-colors duration-300"
                  >
                    Contact Us
                  </Link>
                </div>
