              ...
              <div className="container mx-auto px-4 h-full flex items-center relative z-10 py-32 md:py-40 lg:py-48">
                <div className="grid lg:grid-cols-2 gap-8 md:gap-12 items-center w-full">
                  <div className="flex flex-col space-y-6">
                    ...
                    <button className="inline-block bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-full font-semibold text-base md:text-lg transition-colors duration-300 shadow-lg w-fit">
                      Explore now
                    </button>
                  </div>
      ...
      <section id="products" className="py-16 md:py-20 bg-gradient-to-b from-sky-50 to-blue-50">
        <div className="container mx-auto px-4">
          ...
          <div className="text-center mt-8 md:mt-10">
            <button className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 md:px-8 md:py-3 rounded-full font-semibold text-base md:text-lg transition-colors duration-300">
              See more
            </button>
          </div>
        </div>
            ...
            <div className="bg-white rounded-3xl shadow-xl p-10 lg:p-14">
              <div className="grid lg:grid-cols-2 gap-8 md:gap-12 items-center">
                <div className="space-y-6 md:space-y-8">
                  ...
                  <button className="inline-block bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 md:px-8 md:py-4 rounded-full font-semibold text-base md:text-lg transition-colors duration-300">
                    Contact Us
                  </button>
                </div>
